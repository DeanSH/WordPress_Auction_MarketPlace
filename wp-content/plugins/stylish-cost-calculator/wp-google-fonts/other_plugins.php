 ...
 <div class="wrap">
	<h2>Other Plugins</h2>
        ...
        <p style="border:1px solid #CCCCCC;background:#FFFFFF;padding:8px;">
                ...
                <br /><br />
                <a href="<?php echo admin_url('plugin-install.php?tab=plugin-information&plugin=recent-tweets-widget&TB_iframe=true&width=743&height=500'); ?>" class="thickbox">Recent Tweets Widget</a> - Disccay your recent tweets in a sidebar widget.
                <br /><br />
        ...
        <div style="border:1px solid #CCCCCC;background:#FFFFFF;padding:8px;">
                <form method="post" class="af-form-wrapper" action="http://www.aweber.com/scripts/addlead.pl" target="_blank">
                        ...
                        <input type="hidden" name="meta_sccit_id" value="" />
